...
*!*		?nHandle
*!*		=SQLEXEC(nHandle, 'Select * from nomina','paso')
...
FUNCTION fnSuper(Opc)
DO case
	CASE Opc=1
		 USE ..\MENUMAES\MAESTRO IN 0
		 Do Form Forms\frmSuperviven.Scx WITH 'CENTRO'
	CASE Opc=2
		 USE ..\MENUMAES\RECAUDA\MAESTRO IN 0
		 Do Form Forms\frmSuperviven.Scx WITH 'FORANEOS'
endcase